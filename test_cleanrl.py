...
"""
    ...
    args = tyro.cli(Args)
    run_name = f"StockMarket__{args.exp_name}__{args.seed}__{int(time.time())}"
    if args.track:
        import wandb
    ...
    if args.save_model and global_step % 10000 == 0:
        ...
        """
        eval_policy(eval_env, args.seed, render_ui=False, tb=False)
